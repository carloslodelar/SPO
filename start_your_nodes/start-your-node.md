...
Check whether the node is syncing by fetching the current tip, `--testnet-magic 42` identifies the Shelley testnet a couple of times, `slotNo` should be increasing:
